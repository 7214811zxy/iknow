!function (e, t) {
    ...
    var e, t, i, n = ["Webkit", "Moz", "ms"], o = document.createElement("div").style, r = [1, 8, 3, 6],
        s = [2, 7, 4, 5];
    ...
    function x() {
        ...
        this.options.useCanvas = this.options.enableOrientation || C.call(this), this.data = {}, this.elements = {}, n = this.elements.boundary = document.createElement("div"), r = this.elements.viewport = document.createElement("div"), o = this.elements.img = document.createElement("img"), s = this.elements.overlay = document.createElement("div"), this.options.useCanvas ? (this.elements.canvas = document.createElement("canvas"), this.elements.preview = this.elements.canvas) : this.elements.preview = o, p(n, "cr-boundary"), n.setAttribute("aria-dropeffect", "none"), a = this.options.boundary.width, l = this.options.boundary.height, c(n, {
            ...
            alt: "preview",
            "aria-grabbed": "false"
        }), p(s, "cr-overlay"), this.element.appendChild(n), n.appendChild(this.elements.preview), n.appendChild(r), n.appendChild(s), p(this.element, "croppie-container"), this.options.customClass && p(this.element, this.options.customClass), function () {
            var e, n, o, r, s, a = this, l = !1;

            function h(e, t) {
                var i = a.elements.preview.getBoundingClientRect(), n = s.y + t, o = s.x + e;
            ...
            a.elements.overlay.addEventListener("mousedown", d), a.elements.viewport.addEventListener("keydown", function (e) {
                ...
                if (!e.shiftKey || e.keyCode !== l && e.keyCode !== p) {
                    if (a.options.enableKeyMovement && e.keyCode >= 37 && e.keyCode <= 40) {
                        ...
                        s = g.parse(a.elements.preview), document.body.style[i] = "none", r = a.elements.viewport.getBoundingClientRect(), function (e) {
                            var n = e[0], r = e[1], l = {};
                    ...
                    if (n._currentZoom = i ? i.value : n._currentZoom, o.scale = n._currentZoom, n.elements.zoomer.setAttribute("aria-valuenow", n._currentZoom), a(), n.options.enforceBoundary) {
                        var l = function (e) {
                            var t = this._currentZoom, i = e.width, n = e.height,
                                ...
                                s = this.elements.preview.getBoundingClientRect(), a = s.width, l = s.height, h = i / 2,
                            ...
                            return {
                                translate: {
                                    ...
                                    maxY: p,
                                    minY: p - (l * (1 / t) - n * (1 / t))
                                }, origin: {maxX: a * (1 / t) - d, minX: d, maxY: l * (1 / t) - m, minY: m}
                            }
            ...
            var e, t, n, o, r, s, a, l = this, h = document.createElement("div"), u = !1, d = 50;
            p(h, "cr-resizer"), c(h, {
                width: this.options.viewport.width + "px",
                height: this.options.viewport.height + "px"
            ...
            function f(i) {
                var s = i.pageX, a = i.pageY;
                if (i.preventDefault(), i.touches) {
                    var u = i.touches[0];
                    s = u.pageX, a = u.pageY
                }
                var p = s - t, m = a - n, f = l.options.viewport.height + m, v = l.options.viewport.width + p;
                "v" === e && f >= d && f <= r ? (c(h, {height: f + "px"}), l.options.boundary.height += m, c(l.elements.boundary, {height: l.options.boundary.height + "px"}), l.options.viewport.height += m, c(l.elements.viewport, {height: l.options.viewport.height + "px"})) : "h" === e && v >= d && v <= o && (c(h, {width: v + "px"}), l.options.boundary.width += p, c(l.elements.boundary, {width: l.options.boundary.width + "px"}), l.options.viewport.width += p, c(l.elements.viewport, {width: l.options.viewport.width + "px"})), _.call(l), F.call(l), L.call(l), H.call(l), n = a, t = s
            }
    ...
    function L(i) {
        var n = this._currentZoom, o = this.elements.preview.getBoundingClientRect(),
            ...
            a = new w(this.elements.preview), l = r.top - o.top + r.height / 2, h = r.left - o.left + r.width / 2,
            u = {}, p = {};
        if (i) {
            var d = a.x, m = a.y, f = s.x, v = s.y;
    ...
    function H() {
        var e, t = this.get();
        M.call(this) && (this.options.update.call(this, t), this.$ && "undefined" == typeof Prototype ? this.$(this.element).trigger("update.croppie", t) : (window.CustomEvent ? e = new CustomEvent("update", {detail: t}) : (e = document.createEvent("CustomEvent")).initCustomEvent("update", !0, !0, t), this.element.dispatchEvent(e)))
    }
    ...
    function I() {
        var i, n = {}, o = this.elements.preview, r = new g(0, 0, 1), s = new w;
        M.call(this) && !this.data.bound && (this.data.bound = !0, n[t] = r.toString(), n[e] = s.toString(), n.opacity = 1, c(o, n), i = this.elements.preview.getBoundingClientRect(), this._originalImageWidth = i.width, this._originalImageHeight = i.height, this.data.orientation = y(this.elements.img), this.options.enableZoom ? F.call(this, !0) : this._currentZoom = 1, r.scale = this._currentZoom, n[t] = r.toString(), c(o, n), this.data.points.length ? function (i) {
            ...
            var n = i[2] - i[0], o = this.elements.viewport.getBoundingClientRect(),
                r = this.elements.boundary.getBoundingClientRect(), s = {left: o.left - r.left, top: o.top - r.top},
                a = o.width / n, l = i[1], h = i[0], u = -1 * i[1] + s.top, p = -1 * i[0] + s.left, d = {};
            ...
            var e = this.elements.preview.getBoundingClientRect(), i = this.elements.viewport.getBoundingClientRect(),
                ...
                s = o - (e.width - i.width) / 2, a = r - (e.height - i.height) / 2, l = new g(s, a, this._currentZoom);
            c(this.elements.preview, t, l.toString())
        }.call(this), L.call(this), _.call(this))
    }

    function F(e) {
        var t, i, n, o, r = Math.max(this.options.minZoom, 0) || 0, s = this.options.maxZoom || 1.5,
            a = this.elements.zoomer, l = parseFloat(a.value), h = this.elements.boundary.getBoundingClientRect(),
    ...
    function X(e) {
        var t = e.points, i = m(t[0]), n = m(t[1]), o = m(t[2]) - i, r = m(t[3]) - n, s = e.circle,
            a = document.createElement("canvas"), l = a.getContext("2d"), h = e.outputWidth || o,
            u = e.outputHeight || r;
    ...
    function Y(e, t) {
        var i, n, o, r, s = this, a = [], l = null, h = C.call(s);
        if ("string" == typeof e) i = e, e = {}; else if (Array.isArray(e)) a = e.slice(); else {
        ...
        return s.data.bound = !1, s.data.url = i || s.data.url, s.data.boundZoom = l, (n = i, o = h, r = new Image, r.style.opacity = "0", new Promise(function (e, t) {
            ...
            }.call(s, i), a.length) s.options.relative && (a = [a[0] * i.naturalWidth / 100, a[1] * i.naturalHeight / 100, a[2] * i.naturalWidth / 100, a[3] * i.naturalHeight / 100]); else {
                var n, o, r = f(i), l = s.elements.viewport.getBoundingClientRect(), h = l.width / l.height;
    ...
    function k() {
        var e = this.elements.preview.getBoundingClientRect(), t = this.elements.viewport.getBoundingClientRect(),
            ...
            r = (t.height - this.elements.viewport.offsetHeight) / 2, s = i + this.elements.viewport.offsetWidth + o,
            a = n + this.elements.viewport.offsetHeight + r, l = this._currentZoom;
        (l === 1 / 0 || isNaN(l)) && (l = 1);
    ...
    function N(e) {
        var t = this, i = k.call(t), n = l(h(A), h(e)), o = "string" == typeof e ? e : n.type || "base64",
            r = n.size || "viewport", s = n.format, a = n.quality, u = n.backgroundColor,
